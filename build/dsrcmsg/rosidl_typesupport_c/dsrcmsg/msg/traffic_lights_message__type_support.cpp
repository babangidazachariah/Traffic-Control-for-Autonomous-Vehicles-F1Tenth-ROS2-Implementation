...
static const _TrafficLightsMessage_type_support_symbol_names_t _TrafficLightsMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsrcmsg, msg, TrafficLightsMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dsrcmsg, msg, TrafficLightsMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dsrcmsg, msg, TrafficLightsMessage)() {
  return &::dsrcmsg::msg::rosidl_typesupport_c::TrafficLightsMessage_message_type_support_handle;
}
