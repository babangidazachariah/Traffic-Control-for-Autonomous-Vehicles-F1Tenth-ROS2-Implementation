...
static const _OneCIMKeypoints_type_support_symbol_names_t _OneCIMKeypoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsrcmsg, msg, OneCIMKeypoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsrcmsg, msg, OneCIMKeypoints)),
  }
};
...
{
  return &::dsrcmsg::msg::rosidl_typesupport_cpp::OneCIMKeypoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsrcmsg, msg, OneCIMKeypoints)() {
  return get_message_type_support_handle<dsrcmsg::msg::OneCIMKeypoints>();
}
