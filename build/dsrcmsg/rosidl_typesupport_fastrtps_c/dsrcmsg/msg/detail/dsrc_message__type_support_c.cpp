...
#include "dsrcmsg/msg/detail/dsrc_message__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // approachleg, departureleg, vehicleid
#include "rosidl_runtime_c/string_functions.h"  // approachleg, departureleg, vehicleid

// forward declare type support functions


using _DSRCMessage__ros_msg_type = dsrcmsg__msg__DSRCMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DSRCMessage__ros_msg_type * ros_message = static_cast<const _DSRCMessage__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: departureleg
  {
    const rosidl_runtime_c__String * str = &ros_message->departureleg;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  _DSRCMessage__ros_msg_type * ros_message = static_cast<_DSRCMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: vehicleid
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: departureleg
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->departureleg.data) {
      rosidl_runtime_c__String__init(&ros_message->departureleg);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->departureleg,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'departureleg'\n");
      return false;
    }
  }
...
size_t get_serialized_size_dsrcmsg__msg__DSRCMessage(
  const void * untyped_ros_message,
...
static uint32_t _DSRCMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dsrcmsg__msg__DSRCMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dsrcmsg
size_t max_serialized_size_dsrcmsg__msg__DSRCMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dsrcmsg__msg__DSRCMessage(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_DSRCMessage = {
  "dsrcmsg::msg",
  "DSRCMessage",
...
static rosidl_message_type_support_t _DSRCMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DSRCMessage,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dsrcmsg, msg, DSRCMessage)() {
  return &_DSRCMessage__type_support;
}
