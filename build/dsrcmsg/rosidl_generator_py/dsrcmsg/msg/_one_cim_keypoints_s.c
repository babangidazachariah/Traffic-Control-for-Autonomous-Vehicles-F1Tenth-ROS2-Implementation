...
bool dsrcmsg__msg__one_cim_keypoints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsrcmsg.msg._one_cim_keypoints.OneCIMKeypoints", full_classname_dest, 46) == 0);
  }
  dsrcmsg__msg__OneCIMKeypoints * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of OneCIMKeypoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dsrcmsg.msg._one_cim_keypoints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OneCIMKeypoints");
