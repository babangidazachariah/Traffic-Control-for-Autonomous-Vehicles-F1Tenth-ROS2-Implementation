...
bool dsrcmsg__msg__traffic_lights_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dsrcmsg.msg._traffic_lights_message.TrafficLightsMessage", full_classname_dest, 56) == 0);
  }
  dsrcmsg__msg__TrafficLightsMessage * ros_message = _ros_message;
  {  // pathids
...
{
  /* NOTE(esteve): Call constructor of TrafficLightsMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dsrcmsg.msg._traffic_lights_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrafficLightsMessage");
