...
class PurePursuitPlanner(Node):
    ...
    def __init__(self):
        ...
        self.path_pub = self.create_publisher(MarkerArray, 'waypoints', 10)
        self.waypoints = None 
        ...
        self.load_waypoints('/home/babangida/ros_ws/src/reactivemethods/nsouthopttrajwptsconstvelocity.csv')
    ...
    def timer_callback(self):
        ...
        #Create and publish DSRCMessage
        if self.initTime is None:
            self.initTime =  time.time()
        dsrcmsg = DSRCMessage()
        dsrcmsg.initialtime = self.initTime
        dsrcmsg.currenttime =  time.time()
        dsrcmsg.approachleg = 'NS-Int'
        dsrcmsg.departureleg = 'Int-NS'
        dsrcmsg.disttostopline = 23.50
        dsrcmsg.distfromstopline = 0.0
        dsrcmsg.speed = speed
