...
class CIMAutonomousVehicle(Node):
    ...
    def __init__(self):
        ...
        self.purePursuit = PurePursuitPlanner('/home/babangida/ros_ws/src/onecim/onecim/ns1intersectionwaypointsvelocityprofile.csv', 'wepath', 'wepoint')
