...
class CIMAutonomousVehicle(Node):
    ...
    def __init__(self):
        ...
        self.waitTimeFileName = 'FISHybridCIMsnagent.csv' #FISHybridCIMsnagent  STLSCIMsnagent
