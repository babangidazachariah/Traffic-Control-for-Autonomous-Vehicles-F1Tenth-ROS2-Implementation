    ...
    def PublishVehicles(self):
        ...
        for vehicle in self.eastSouth:
            if vehicle[4] <= self.MINSTOPLINEDIST and vehicle[4] >= -(self.MINSTOPLINEDIST * 0.19):
                self.PublishDSRCMsg(vehicle, 'eastpath') #vehicle and corresponding topic
                veh += 1
        ...
        for vehicle in self.southWest:
            if vehicle[4] <= self.MINSTOPLINEDIST and vehicle[4] >= -(self.MINSTOPLINEDIST * 0.19):
                self.PublishDSRCMsg(vehicle, 'southpath') #vehicle and corresponding topic
                veh += 1
        ...
        for vehicle in self.northSouth:
            if vehicle[4] <= self.MINSTOPLINEDIST and vehicle[4] >= -(self.MINSTOPLINEDIST * 0.19):
                self.PublishDSRCMsg(vehicle, 'northpath') #vehicle and corresponding topic
                veh += 1
                northCount += 1
        ...
        for vehicle in self.westEast:
            if vehicle[4] <= self.MINSTOPLINEDIST and vehicle[4] >= -(self.MINSTOPLINEDIST * 0.19):
                self.PublishDSRCMsg(vehicle, 'westpath') #vehicle and corresponding topic
                veh += 1
