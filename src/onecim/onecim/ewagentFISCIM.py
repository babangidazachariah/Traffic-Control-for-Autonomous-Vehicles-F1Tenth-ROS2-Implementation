...
class CIMAutonomousVehicle(Node):
    ...
    def __init__(self):
        ...
        self.purePursuit = PurePursuitPlanner('/home/babangida/ros_ws/src/onecim/paths/Processed/es0wptsvelocityprofile.csv', 'ewpath', 'ewpoint')
        ...
        self.approachLeg = 'ES0'
        self.departureLeg = 'ES0'
        ...
        self.waitTimeFileName = '/home/babangida/ros_ws/src/onecim/results/onecimewagent.csv' #FISHybridCIMewagent  STLSCIMewagent
        ...
        self.currStopLinePoint = self.GetStopLine('ES0')
    ...
    def ChoosePath(self):
        ...
        self.purePursuit = PurePursuitPlanner(wptsPath, 'ewpath', 'ewpoint')
    ...
    def StartStopDSRCMsgs(self, poseX, poseY, appLeg, deptLeg):
        ...
        if dist <= self.MINSTOPLINEDIST: #vehicle should be publishing DSRC Messages
            ...
            if self.toFroStopLine: #If it true, vehicle is yet at the intersection or gone past intersection 
                ...
                #print('Recorded Arrival Time on: ',self.approachLeg)
...
def main(args=None):
    ...
    print("FIS-Based Decentralized Cooperative Intersection Management Aware East-West Controller Node")
