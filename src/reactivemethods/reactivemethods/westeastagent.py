...
class PurePursuitPlanner(Node):
    ...
    def __init__(self):
        ...
        self.path_pub = self.create_publisher(MarkerArray, 'wewpt', 10)
        self.waypoints = None 
        #'/home/babangida/ros_ws/northsouth2d.csv'   nsouthopttrajwptsconstvelocity   nsouthopttrajwpts  weastopttrajwptsconstvelocity
        ...
        self.load_waypoints('/home/babangida/ros_ws/src/reactivemethods/weastopttrajwptsconstvelocity.csv')
