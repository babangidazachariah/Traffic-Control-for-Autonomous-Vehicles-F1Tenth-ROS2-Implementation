...
class CIMAutonomousVehicle(Node):
    ...
    def __init__(self):
        ...
        self.dsrcSubscriber = self.create_subscription(TrafficLightsMessage, '/tls', self.TlsBasedTrajectoryPlanning, 2) # qos_profile=rclpy.qos.qos_profile_system_default)
        ...
        self.distFromStopLine = 2000 #set to a very large value
        ...
        self.waitTimeFileName = 'FISHybridCIMewagent.csv' #FISHybridCIMewagent  STLSCIMewagent
    ...
    def TlsBasedTrajectoryPlanning(self, tlsmsg):
        ...
        if tlsmsg.starttime is not None and self.arrivalTime is not None:
            ...
            if self.approachLeg not in tlsmsg.pathids : #Check to ensure the received tls message is for the vehicle path - vehicle path scheduled
                ...
                print('distFromStopLine: ', self.distFromStopLine, ' Duration: ', dur)
