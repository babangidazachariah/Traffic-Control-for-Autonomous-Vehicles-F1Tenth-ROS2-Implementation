...
class CIMAutonomousVehicle(Node):
    ...
    def __init__(self):
        ...
        self.purePursuit = PurePursuitPlanner()
        self.speed = 1.0
        ...
        self.dsrcPublisher = self.create_publisher(DSRCMessage, '/dsrcmsg', qos_profile=rclpy.qos.qos_profile_system_default)
        #Create DSRCMessage subscriber
        self.dsrcSubscriber = self.create_subscription(DSRCMessage, '/dsrcmsg', self.ScheduleTraffic, qos_profile=rclpy.qos.qos_profile_system_default)
